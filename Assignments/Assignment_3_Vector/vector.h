...
typedef struct {
	void* elems;
	int elemSize;
	int allocLength; // allocated length of the elements array
	int logicalLength; // length of the portion of the elements array that is populated 
	int initialLength; // initial allocated length of the elements array
